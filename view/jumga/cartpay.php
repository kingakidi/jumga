...
<form>
  ...
  <button class="btn btn-jumga" type="button" onClick="makePayment()">Pay Now </button>
</form>
...
<script>
  ...
  function makePayment() {
    FlutterwaveCheckout({
      public_key: "FLWPUBK_TEST-dcf6418b844bc45ae0a7fc1382d927ff-X",
    ...
    "redirect_url": "http://localhost/jumga/cartpayment.php"
